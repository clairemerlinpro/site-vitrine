...
const Tree = require_factory.factory((_props) => {
	...
	const mergedRef = (0, _mantine_hooks.useMergedRef)(ref, (0, _mantine_hooks.useClickOutside)(() => clearSelectionOnOutsideClick && controller.clearSelected()));
	const flatValues = (0, react.useMemo)(() => getFlatValues(data), [data]);
	(0, react.useEffect)(() => {
		controller.initialize(data);
	}, [data]);
	const nodes = data.map((node, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_TreeNode.TreeNode, {
		node,
		getStyles,
		rootIndex: index,
		expandOnClick,
...
Tree.classes = require_Tree_module.default;
